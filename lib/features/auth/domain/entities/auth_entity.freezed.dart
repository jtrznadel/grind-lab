...
/// @nodoc
class $AuthEntityCopyWith<$Res>  {
$AuthEntityCopyWith(AuthEntity _, $Res Function(AuthEntity) __);
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  authenticated,TResult Function()?  unauthenticated,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Authenticated() when authenticated != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  authenticated,required TResult Function()  unauthenticated,}) {final _that = this;
switch (_that) {
case _Authenticated():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  authenticated,TResult? Function()?  unauthenticated,}) {final _that = this;
switch (_that) {
case _Authenticated() when authenticated != null:
return authenticated();case _Unauthenticated() when unauthenticated != null:
return unauthenticated();case _:
...
class _Authenticated implements AuthEntity {
...
@override
String toString() {
  return 'AuthEntity.authenticated()';
}
...
class _Unauthenticated implements AuthEntity {
...
@override
String toString() {
  return 'AuthEntity.unauthenticated()';
}
